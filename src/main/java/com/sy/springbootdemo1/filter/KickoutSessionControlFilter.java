...
public class KickoutSessionControlFilter extends AccessControlFilter {
    ...
    protected boolean onAccessDenied(ServletRequest request, ServletResponse response) throws Exception {
        ...
        System.out.println("已验证："+subject.isAuthenticated());
        System.out.println("已记住我："+subject.isRemembered());
...
//        String username = ((Users) subject.getPrincipal()).getAccount();
//        System.out.println(JSON.toJSONString(subject.getPrincipal()));
        ...
        ConcurrentHashMap<String,Object> client_side = new ConcurrentHashMap<>();
